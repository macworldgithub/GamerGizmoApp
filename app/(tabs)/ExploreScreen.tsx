...
//       return { pageName: "Laptops", totalAds: 3 };
//     } else if (lowerCategory === "components" || lowerCategory === "accessories") {
//       return { pageName: "Components & Accessories", totalAds: 3 };
//     } else if (lowerCategory === "desktop") {
//       return { pageName: "Gaming PC", totalAds: 3 };
//     } else if (lowerCategory === "console") {
//       return { pageName: "Consoles", totalAds: 3 };
//     } else {
//       return null;
//     }
//   };
...
//               {(index + 1) % 3 === 0 && (
//                 <View className="mt-4">
//                   <LiveAds pageName={adData.pageName} adId={adData.adId} />
//                 </View>
//               )}
//             </React.Fragment>
//           );
...
const ExploreScreen = () => {
  ...
  const getAdsInfo = (category: string | string[], condition: string | string[]) => {
    ...
    if (lowerCategory === "laptops" && (conditionValue === "1" || conditionValue === "2")) {
      return { pageName: "Laptops", adId: "laptops" };
    } else if (lowerCategory === "components" || lowerCategory === "accessories") {
      return { pageName: "Components & Accessories", adId: "components" };
    } else if (lowerCategory === "desktop") {
      return { pageName: "Gaming PC", adId: "desktop" };
    } else if (lowerCategory === "console") {
      return { pageName: "Consoles", adId: "console" };
    } else {
      return null;
    }
  };
        ...
        {products.map((item, index) => (
          <React.Fragment key={index}>
            <View className="bg-white p-3 mb-4 rounded-lg shadow-md border border-gray-200">
              ...
              <Text className="text-black font-bold mt-1" numberOfLines={1}>
                {item.name}
              </Text>
