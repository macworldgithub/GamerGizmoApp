...
const ExploreScreen = () => {
 ...
 // Remove minPrice, maxPrice params and related code
const handleFilter = async ({ city }: { city?: string }) => {
  try {
    setLoading(true);
  ...
  // Baaki component ka code waise ka waise hi
      ...
      <View className="bg-white">
        ...
        <View className="mt-4 flex-row items-center justify-center px-4 py-4 border-t border-gray-200">
          ...
          <FilterModal
            ...
            onApplyFilter={handleFilter}  // Yahan handleFilter pass kar rahe hain
          />
          <Text className="text-gray-400">|</Text>
          <TouchableOpacity
            onPress={() => setSortVisible(true)}
